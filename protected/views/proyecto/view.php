...
<div class="row">
	<div class="col-sm-12 col-md-6 col-lg-6">
		<table class="table table-striped table-bordered display well">
			...
			<tbody>
				<?php $c=0; foreach($actividadesPendientes as $ap){$costoActPen = $costoActPen + $ap->costo;  $c++; ?>
				<tr>
					<td><?php echo $c;?></td>
	...
	<div class="col-sm-12 col-md-6 col-lg-6">
		<table class="table table-striped table-bordered display well">
			...
			<tbody>
				<?php $c=0; foreach($actividadesRealizadas as $ar){ $costoActTerm = $costoActTerm + $ar->costo; $c++; ?>
				<tr>
					<td><?php echo $c;?></td>
	        ...
	        <div class="panel-heading">
	          <div class="row">
	            <div class="col-xs-12">
	              ...
	              <h1 style="font-size:40pt;"><strong>$<?php echo $costoActTerm;?></strong></h1>
	            </div>
	          </div>
	        </div>
   		</div>
	        ...
	        <div class="panel-heading">
	          <div class="row">
	            <div class="col-xs-12">
	              ...
	              <h1 style="font-size:40pt;"><strong>$<?php echo $costoActPen;?></strong></h1>
	            </div>
	          </div>
	        </div>
   		</div>
	        ...
	        <div class="panel-heading">
	          <div class="row">
	            <div class="col-xs-12">
	              ...
	              <h1 style="font-size:40pt;"><strong>$<?php echo $model->costo; ?></strong></h1>
	            </div>
	          </div>
	        </div>
   		</div>
