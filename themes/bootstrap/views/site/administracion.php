        ...
        <div class="panel-heading">
          <div class="row">
            ...
            <div class="col-xs-6 text-right">
              <h1 style="font-size:40pt;"><strong><?php echo Proyecto::model()->count();?></strong></h1>
      ...
      <div class="panel panel-warning">
        <div class="panel-heading">
          <div class="row">
            ...
            <div class="col-xs-6 text-right">
              <h1 style="font-size:40pt;"><strong><?php echo Proyecto::model()->count("estatus_did = 2");?></strong></h1>
      ...
      <div class="panel panel-danger">
        <div class="panel-heading">
          <div class="row">
            ...
            <div class="col-xs-6 text-right">
              <h1 style="font-size:40pt;"><strong><?php echo Proyecto::model()->count("estatus_did = 1");?></strong></h1>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
          <div class="row">
            ...
            <div class="col-xs-6 text-right">
              <h1 style="font-size:40pt;"><strong><?php echo Proyecto::model()->count("estatus_did = 3");?></strong></h1>
